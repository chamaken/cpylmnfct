...
def main():
    ...
    with mnl.Socket(netlink.NETLINK_NETFILTER) as nl:
        ...
        # filter_mark = nfct.FilterMark(value=1, mask=-1)
        filter_proto = nfct.FilterProto(proto=socket.IPPROTO_TCP)
        # skfilter.add_attr(nfct.NFCT_FILTER_MARK, filter_mark);
        skfilter.add_attr(nfct.NFCT_FILTER_L4PROTO, filter_proto);
