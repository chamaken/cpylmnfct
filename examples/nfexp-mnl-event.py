...
def main():
    ...
    with mnl.Socket(netlink.NETLINK_NETFILTER) as nl:
        nl.bind(nfnl_compat.NF_NETLINK_CONNTRACK_EXP_NEW |\
                    nfnl_compat.NF_NETLINK_CONNTRACK_EXP_UPDATE |\
                    nfnl_compat.NF_NETLINK_CONNTRACK_EXP_DESTROY,
